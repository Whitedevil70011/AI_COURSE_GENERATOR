...
function CourseSidebar({ course, modules, activeLessonId, courseId }) {
  ...
  return (
    <aside className="w-80 shrink-0 border-r border-slate-200/80 bg-white/75 backdrop-blur-xl flex flex-col h-[calc(100vh-73px)] sticky top-[73px] text-slate-900 select-none shadow-[10px_0_30px_-24px_rgba(15,23,42,0.25)]">
      
      {/* ── Header ── */}
      <div className="p-5 flex flex-col gap-4 border-b border-slate-100/80">
        ...
        <div 
          ...
          className="flex items-center gap-3 rounded-2xl bg-white/80 px-4 py-3 shadow-[0_14px_34px_-28px_rgba(15,23,42,0.45)] ring-1 ring-slate-200/70 hover:ring-slate-300 transition-all duration-200 cursor-pointer"
        >
